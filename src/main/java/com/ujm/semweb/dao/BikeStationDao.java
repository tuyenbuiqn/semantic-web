...
public class BikeStationDao {
	...
	private String GRAPH_REPO_QUERY = "http://localhost:7200/repositories/graphdb1";
    @Value("${GRAPH_REPO_UPDATE}")
    //private String GRAPH_REPO_UPDATE ;
    private String GRAPH_REPO_UPDATE  = "http://localhost:7200/repositories/graphdb1/statements";
